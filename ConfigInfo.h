...
typedef struct _SystemInfo
{
	...
	int m_iTest;
	bool m_bDebugMode;	
	int m_iSystemType;			//系统类型 0:瓶身系统，1：瓶口瓶底系统，2：一体机系统(14相机)，3：一体机系统(10相机),4:瓶身2光电，5：药玻一体机,6: 瓶身单独应力一体机。
...
//	int m_iIsTrackErrorType;	
	...
	int iWebServerPort;
	int iIfCountDetectNumberByCamera;
	int iIOCardOffSet;
...
//		m_bIfNoFind = FALSE;
		...
		iIfCountDetectNumberByCamera = 0;
...
//	e_CurrentSettingPage m_eLastSettingPage;
	...
	QString sGSoap_ErrorTypeName[ERRORTYPE_MAX_COUNT];//每个错误类型的名称
