...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.8.25 2017-06-27 07:44:00 GMT")
...
{	struct ns__getInfo soap_tmp_ns__getInfo;
	...
	soap_tmp_ns__getInfo.nOrder = nOrder;
	soap_tmp_ns__getInfo.nReserveReq = nReserveReq;
	soap_begin(soap);
	soap->encodingStyle = "";
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_ns__getInfo(soap, &soap_tmp_ns__getInfo, "ns:getInfo", NULL)
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_get_ns__Detectinfo(soap, buf_out, "", NULL);
	if (soap->error)
