...
void MyImageShowItem::slots_updateImage(QImage* imageShown,QString camera, QString imageSN,QString time, QString result, QString mouldID, QList<QRect> listRect,int QueenID)
{
	...
	updateImage(imageShown,camera, imageSN,time, result, mouldID, listRect);
}
