...
{
	pMainFrm->Logfile.write(QObject::tr("ReleaseUserWidget"),OperationLog);
//	delete sqliteUser;
}
...
//	if (pMainFrm->m_sRunningInfo.m_iPermission > 0)
	...
	pMainFrm->Logfile.write(tr("Log in"),OperationLog,0);
...
// 			if (newPassWord == newPassWord2)
			{
				...
				pMainFrm->Logfile.write(tr("UserChange PassWord"),OperationLog,0);
...
// 			if (newPassWord == newPassWord2)
			{
				...
				setSuccess = true;
				QMessageBox::information(this,tr("Information"),tr("The new password set successfully"));
				pMainFrm->Logfile.write(tr("Admin Change PassWord"),OperationLog,0);
